...
st.image('./assets/imagens/pandas_masterclass/aula_01/banner_aula_01.png', width='stretch')

# --- Link do vídeo --- #
st.subheader('Para assitir essa aula, clique [aqui](https://youtu.be/luIGjQQtTPY).')
